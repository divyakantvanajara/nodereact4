...
function Menu()
{
  return( <nav className="navbar navbar-expand-xl navbar-dark bg-dark fixed-top" >
...
{
  return(<div className="col-md-3 col-sm-12 my-5">
  <div className="card">
...
function Catagory()
{
  return (<div className="events-schedules-area  mt-5 " id="category">
  <div className=" ">
  ...
  <div className="container">
    <div className="row">
      ...
      <SingleCatagory name='Student Visa' photo='https://picsum.photos/200/300' detail='Studying In The canada The generom repetition jected humour, or non-characteristic words etc.'/>
      <SingleCatagory name='Business Visa' photo='https://picsum.photos/200/301' detail='Business Visa Quam semper simple dummy eleifend lorem in imperdiet mauri et efficitur lorem ipsum.'/>
      <SingleCatagory name='Job Seeker Visa' photo='https://picsum.photos/200/302' detail='Duis id quam semper, eleifend lorem in, imperdiet mauris simple estibulum imple et efficitur nunc.'/>
      <SingleCatagory name='Tourist Visitor Visa' photo='https://picsum.photos/200/303' detail='Suspendisse lobortis eros ac blan mi aliquet justo sit amet aliquet nunc simple dummy content risus a felis.'/>
    </div>
  </div>
</div>);
}
function AboutUs()
{
  return(<div className="events-schedules-area  mt-5 " id="aboutus">
  <div className=" ">
    <div className="section-title ml-5 " id="category">
...
function ContactUs()
{
  return( <div className="events-schedules-area  mt-5 " id="contactus">
  <div className=" ">
...
function SingleReview(props)
{
  ...
  <div className="card" style={{"background-image":"url('images/whiteimages.jpg')"}}>
    <div className="card-body">
      <div className="space">
        <img src={props.photo} alt height="150px" />
        <h1>{props.name}</h1>
        <p>{props.detail}</p>
      </div>
    </div>
...
function Reviews()
{
  return(<div className="events-schedules-area  mt-5 " id="reviews">
  <div className=" ">
    <div className="section-title ml-5 " id="category">
  ...
  <div id="carouselExampleDark1" className="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div className="carousel-inner">
     ...
     <SingleReview name ='John Doe' photo='https://picsum.photos/1300/402' datail='Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illum non quisquam tenetur
          voluptate sequi voluptatum quo, itaque vitae corporis magni?'/>
          
       <SingleReview name ='Doe John' photo='https://picsum.photos/1300/403' datail='Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illum non quisquam tenetur
          voluptate sequi voluptatum quo, itaque vitae corporis magni?'/>
          <SingleReview name ='Michal John Doe' photo='https://picsum.photos/1300/404' datail='Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illum non quisquam tenetur
          voluptate sequi voluptatum quo, itaque vitae corporis magni?'/>
    </div>
