...
function Menu()
{
  return (<nav className="navbar navbar-expand-xl navbar-dark bg-dark fixed-top mb-5">
...
function Slider()
{
    return ( <div id="carouselWithIndicators" className="carousel slide" data-bs-ride="carousel mt-5">
...
function SingleTempleOfShiva(props)
{
    return(<div className="col-lg-3 col-md-4 col-sm-6 col-12">
    <div className="card shadow">
      <img src={props.photo} className="card-img-top" alt="card-img-top" />
...
function TempleOfShiva()
{
    return(<div className="row mb-3">
    <div className="col-12 mb-3">
      <h2 id="courses" className="border-bottom">Temple of Shiva</h2>
    </div>
    <SingleTempleOfShiva name='The Bhavnath Mahadev ' photo='5.jpg' detail='The Bhavnath Mahadev temple is a shrine ensconced in myths and legends of the Puranic era, at the base of Mount Girnar in Bhavnath village. The Shiva ling here is said to have emerged of its own divine intention.'/>
    <SingleTempleOfShiva name='Shree Somnath Jyotirling ' photo='6.jpg' detail='The Somnath temple, also called Somanātha temple or Deo Patan, is a Hindu temple located in Prabhas Patan, Veraval in Gujarat, India. It is one of the most sacred pilgrimage sites for Hindus and is believed to be.'/>
    <SingleTempleOfShiva name='Mahakaleshwar Jyotirling ' photo='7.jpg' detail='Mahakaleshwar Jyotirlinga is a Hindu temple dedicated to Shiva and is one of the twelve Jyotirlingas, shrines which are said to be the most sacred abodes of Shiva. It is located in the ancient city of Ujjain in .'/>
    <SingleTempleOfShiva name='Omkareshwarn Jyotirling' photo='8.jpg' detail='Omkareshwar is a Hindu temple dedicated to Shiva, located in Mandhata, nearby Khandwa city in Khandwa district of the Indian state of Madhya Pradesh. It is one of the 12 revered Jyotirlinga shrines of Shiva    .'/>
    ...
    <div className="card shadow">
      <div className="row g-0">
        <div className="col-5 col-sm-4">
          <img src={props.photo} className="img-fluid w-100" alt="card-horizontal-image" />
        </div>
...
function Catagory()
{
    return(<div className="container-fluid mb-5 bg-light p-5">
    <div className="row">
      <div className="col-10 offset-1">
        <div className="row">
         ...
         <SingleCatagory name='Shiva in Mythology' photo='9.jpg' detail='As with any major god, Shiva was involved in many adventurous episodes which illustrate his virtuous character and offer instruction on how to live correctly.'/>
         <SingleCatagory name='Shiva in Art' photo='9.jpg' detail='In Asian art Shiva may be represented in slightly different ways depending on the particular culture: Indian, Cambodian, Javanese etc. but he is most common.'/>
